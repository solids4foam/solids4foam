...
:
    List<Tuple2<scalar, Type>>(),
    boundsHandling_(interpolationTable::WARN),
    reader_(new TableReaders::Foam<Type>(fName.name(), dictionary(), *this))
{}
...
:
    ...
    reader_(TableReader<Type>::New(dict.dictName(), dict, *this))
{}
...
:
    ...
    reader_(interpTable.reader_, false)    // note: steals reader. Used in write().
{}
