...
//    const SparseMatrixTemplateData& data = matrix.data();
//    for
//    (
//        SparseMatrixTemplateData::const_iterator iter = data.begin();
//        iter != data.end();
//        ++iter
//    )
//    {
...
//            {
//                // Prepare values
//                const PetscScalar values[1] = {sourceI};
