...
- Demonstrate solver ability when modelling large-strain plasticity;

---

## Case Overview

This case considers the necking of a cylinder bar subjected to uniaxial tension. The problem geometry is shown in Figure 1 and is represented as axisymmetric. The initial cylindrical bar radius $$r_0$$ is $$6.413$$ mm and the initial length $$l_0$$ is $$53.334$$ mm, where there is no initially narrowed neck region. The mechanical properties of the bar are given in Table 1. 
...
The two end surfaces of the bar are slowly displaced through a distance of $$7$$ mm in opposite directions, where no tangential contraction of the ends is allowed i.e. the tangential displacement is zero. Due to symmetry, one half of the bar is simulated, and symmetry plane conditions are employed. Mesh consists of $$600$$ CVs; refinement is made near the expected neck, similar to the setup of [2]. Gravity and transient effects are neglected. The case is solved using $$500$$ equal loading increments.

**Table 1: Mechanical properties**

|      Hardening       | Plastic strain | Yield Stress (in MPa) |
| :------------------: | :------------: | :-------------------: |
|                      |   $$0.000$$    |        $$451$$        |
|                      |   $$0.006$$    |        $$476$$        |
|                      |   $$0.019$$    |        $$525$$        |
...
- As the elongation is increased, the decrease in radius becomes strongly non-uniform, so-called "necking". The neck is the location where strains are being accumulated more intensively due to the concentration of stress in that region. This leads to a reduction in the cross-sectional area of the specimen. Necking phenomena start to occur when the ultimate strength of the material is reached. The development of the necking is shown in Figure 2.

<div style="text-align: center;">
  <img src="./images/neckingBar-meshDeformation.png" alt="Image" width="700">
    <figcaption>
     <strong>Figure 2: The initial mesh and the deformed mesh at a load step of 350, 400, 450 and 500 (computational mesh is coloured red, the remaining mesh is mirrored)</strong>
    </figcaption>
</div>
