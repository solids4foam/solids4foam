# Plot the displacement and stress error norms against the mesh spacing, with
# first- and second-order guide slopes.
#
...
plot data using 1:2 with linespoints pt 6 ps 0.8 lc rgb "#d7191c" \
         title "displacement L_2", \
     data using 1:3 with linespoints pt 7 ps 0.8 lc rgb "#fdae61" \
         title "displacement L_{/Symbol \245}", \
     data using 1:4 with linespoints pt 8 ps 0.8 lc rgb "#2c7bb6" \
         title "stress L_2", \
     data using 1:5 with linespoints pt 9 ps 0.8 lc rgb "#1a9641" \
         title "stress L_{/Symbol \245}", \
