...
- **Solid**
  - Young's modulus (`E`): 0.5 kPa
  - Density (`\rho`): 1 kg m$$^{-3}$$
  - Poisson ratio (`\nu`): 0.3
  - Coefficient of thermal expansion (`\alpha`): $$10^{-5}$$ K$$^{-1}$$
  - Thermal conductivity (`k`): 0.04 W/(m K)
  - Specific heat capacity (`C_p`): 1010 J/(kg K)
  - Reference temperature (`T_0`): 0 K
- **Fluid**
  - Viscosity (`\mu`): $$2.15\times10^{-5}$$ Pa s
  - Density (`\rho`): 1 kg m$$^{-3}$$
  - Coefficient of thermal expansion (`\beta`): $$0.00285$$ K$$^{-1}$$
  - Thermal conductivity (`\lambda`): 0.03 W/(m K)
  - Specific heat capacity (`C_p`): 1010 J/(kg K)
